    ...
    <div class="row d-flex d-md-block flex-nowrap wrapper">
        <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
            <div class="list-group border-0 card text-center text-md-left customfix">
                ...
                <!--Navbar items-->
                <a href="/dashboard" class="list-group-item d-inline-block collapsed navbar-brand" data-parent="#sidebar" id="desktopimg"><img src="../assets/Logo-gezinshuis/Breed/GezinshuisRegterink_Logo.png" class="logo"></a>
