...
?>
        ...
        foreach ($results as $items) {
            ...
            echo '
                            <form action="/dashboard/gebruiker" method="get"><input hidden value="' . $items->id . '" name="id"><a onclick="$(this).closest(\'form\').submit()" href="#">
                              <div class="card-body">
            ...
            if ($_SESSION['function'] == 'Admin') {
                echo '
                            <div class="card-footer text-right" style="float:right">
                                ...
                                <form action="edit_user" method="post" style="float:right">
                                    <button class="btn btn-primary text-right" aria-label="Edit" name="id" value="' . $items->id . '">
